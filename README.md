# Notebook CRUD - Менеджер контактов

Современное Qt Quick приложение для управления списком контактов с интуитивным интерфейсом и полным функционалом CRUD операций.

## ✨ Функции

- ✅ **Просмотр списка контактов** с аватарами и красивым дизайном
- ✅ **Добавление новых контактов** через кнопку "➕"
- ✅ **Редактирование inline** - просто кликните по любому полю
- ✅ **Placeholder текст** для пустых полей
- ✅ **Удаление свайпом** - проведите влево для удаления
- ✅ **Подсчёт контактов** в реальном времени
- ✅ **Адаптивный UI** - минимальный размер окна 480x400
- ✅ **Подсказки** - hover эффекты и tooltips
